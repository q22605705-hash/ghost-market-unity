...
## ART-REQ-010 - Projectile effect sheet sources    status: done (Claude 2026-07-06)

Integrated: normalized both kits (green removal, kept 256px cells). Enemy/boss projectiles now fly as the painted comet frame (frame 3, rotated to velocity, boss uses the dark kit) layered with the additive glow, live embers and afterimages; impacts on the player play the painted burst frame (frame 4) scaling out over 0.24s via a small projBursts pool. Verified with in-flight and impact screenshots; loops green.
